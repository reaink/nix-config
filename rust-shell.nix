...
pkgs.mkShell {
  ...
  shellHook = ''
    ...
    echo "  patchelf --set-interpreter $(cat $NIX_CC/nix-support/dynamic-linker) --set-rpath ${pkgs.lib.makeLibraryPath [ pkgs.openssl pkgs.openssl_3 pkgs.stdenv.cc.cc.lib ]} ./your-binary"
  '';
}
